...
class UserInfoController(
    ...
    fun getUserInfo(
        ...
        return try {
            ...
            val userInfoResponse = userInfoService.getUserInfo(currentUser)
    ...
    fun updateUserInfo(
        ...
        return try {
            val currentUser = resolveUser(user)
            val fixedUser = userInfoService.fixUserInfo(currentUser, request)
    ...
    fun getUserMileage(
        ...
        return try {
            val currentUser = resolveUser(user)
            val myMilage = userInfoService.getUserMileges(currentUser)
